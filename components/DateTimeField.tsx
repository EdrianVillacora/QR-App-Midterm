      ...
      <Modal visible={open} transparent animationType="fade" onRequestClose={close}>
        <View style={styles.scrim}>
          <View accessibilityViewIsModal style={styles.modal}>
            ...
            <DateTimePicker
              display={mode === 'date' ? (Platform.OS === 'ios' ? 'inline' : 'calendar') : (Platform.OS === 'ios' ? 'spinner' : 'clock')}
...
const styles = StyleSheet.create({
  ...
  modal: { backgroundColor: COLORS.card, borderRadius: 20, padding: 18, borderWidth: 2, borderColor: COLORS.primary, gap: 12 },
  modalHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  modalTitle: { color: COLORS.primaryDark, fontSize: 20, fontWeight: '800' },
