...
const styles = StyleSheet.create({
  ...
  content: { width: '100%', maxWidth: 760, alignSelf: 'center', padding: 20, paddingBottom: 40, gap: 20 },
  fill: { flex: 1 },
  header: { minHeight: 48, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  title: { color: COLORS.primaryDark, fontSize: 28, lineHeight: 34, fontWeight: '800', letterSpacing: -0.4 },
});
