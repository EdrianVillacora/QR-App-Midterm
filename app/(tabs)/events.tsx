...
export default function EventsScreen() {
  ...
  if (role === null) {
    return <Screen title="Events" scroll={false}><View style={styles.center}><ActivityIndicator color={COLORS.primary} /></View></Screen>;
  }
    ...
    <Screen title="Events">
      ...
      {payload ? (
        <View style={styles.qrCard}>
          <QRCode value={payload} size={220} backgroundColor={COLORS.card} color={COLORS.primaryDark} />
...
const styles = StyleSheet.create({
  ...
  qrCard: { borderWidth: 2, borderColor: COLORS.primary, borderRadius: 20, padding: 20, alignItems: 'center', gap: 14, backgroundColor: COLORS.card },
  code: { color: COLORS.primaryDark, fontSize: 15, fontWeight: '800', letterSpacing: 1, backgroundColor: COLORS.accentSoft, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 999 },
});
