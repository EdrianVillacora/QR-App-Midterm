...
export default function HistoryScreen() {
  ...
  return (
    <Screen title="Attendance">
      {loading ? <ActivityIndicator color={COLORS.primary} /> : role === 'teacher' ? <TeacherHistory events={teacherEvents} /> : <StudentHistory records={studentRecords} />}
    </Screen>
  );
}
...
const styles = StyleSheet.create({
  list: { gap: 12 },
  card: { borderWidth: 1, borderColor: COLORS.border, borderRadius: 16, backgroundColor: COLORS.card, overflow: 'hidden' },
  cardTitle: { color: COLORS.primaryDark, fontSize: 17, fontWeight: '800' },
  studentHeading: { paddingHorizontal: 16, paddingTop: 16 },
  ...
  empty: { minHeight: 180, borderWidth: 1, borderColor: COLORS.border, borderRadius: 16, backgroundColor: COLORS.card, alignItems: 'center', justifyContent: 'center', gap: 10 },
