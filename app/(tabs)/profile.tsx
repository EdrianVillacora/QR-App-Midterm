          ...
          <View style={styles.details}>
            <View style={styles.row}>
              ...
              {editing ? (
                ...
                <Pressable accessibilityRole="button" accessibilityLabel="Edit full name" onPress={() => setEditing(true)} style={styles.editName}>
...
const styles = StyleSheet.create({
  badge: { alignSelf: 'flex-start', backgroundColor: COLORS.accent, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 6 },
  badgeText: { color: COLORS.primaryDark, fontSize: 12, fontWeight: '800', letterSpacing: 1.2 },
  details: { borderWidth: 1, borderColor: COLORS.border, borderRadius: 16, backgroundColor: COLORS.card, overflow: 'hidden' },
