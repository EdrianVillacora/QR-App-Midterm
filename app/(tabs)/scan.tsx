...
const styles = StyleSheet.create({
  ...
  cameraFrame: { flex: 1, minHeight: 300, borderWidth: 3, borderColor: COLORS.accent, borderRadius: 20, overflow: 'hidden', backgroundColor: COLORS.primaryDark },
  guide: { position: 'absolute', width: 220, height: 220, left: '50%', top: '50%', marginLeft: -110, marginTop: -110, borderWidth: 4, borderColor: COLORS.accent, borderRadius: 16 },
});
