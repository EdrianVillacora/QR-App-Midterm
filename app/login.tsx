      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.container}>
        <View style={styles.form}>
          <View style={styles.mark}>
            <Ionicons name="qr-code" size={28} color={COLORS.primaryDark} />
          </View>
...
const styles = StyleSheet.create({
  ...
  form: { width: '100%', maxWidth: 460, alignSelf: 'center', gap: 18, backgroundColor: COLORS.card, borderWidth: 1, borderColor: COLORS.border, borderRadius: 24, padding: 24 },
  mark: { width: 56, height: 56, borderRadius: 18, backgroundColor: COLORS.accent, alignItems: 'center', justifyContent: 'center' },
  title: { color: COLORS.primaryDark, fontSize: 32, fontWeight: '800', marginBottom: 6 },
